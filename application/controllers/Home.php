			                                    ...
			                                    <table width="500" cellspacing="0" cellpadding="0" border="0" align="center" style="background-color: #415564;padding: 15px 20px;">
			                                        <tr>
			                                            <td>
			                                                <table>
			                                                    <tr>
			                                                        <td><a href="#"><img src="http://www.marketinghp.net/microsite/DCN/evento_rd/public/img/logo/hpe-vmware.png" width="240" alt="alternative text" border="0" style="display: block;"></a></td>
			                                                        <td></td>
			                                                    </tr>
			                                                </table>
			                                            </td>
